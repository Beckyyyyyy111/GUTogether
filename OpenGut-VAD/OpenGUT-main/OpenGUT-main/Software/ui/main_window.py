...
from audio_moments import DEFAULT_ORIGINAL_SOUNDS_DIR
from const import (
    APP_WINDOW_GEOMETRY,
    APP_WINDOW_TITLE,
...
class MainWindow(QMainWindow):
    ...
    def open_audio_file(self):
        ...
        start_dir = str(DEFAULT_ORIGINAL_SOUNDS_DIR) if DEFAULT_ORIGINAL_SOUNDS_DIR.exists() else str(Path.home())
