...
# Playback clip builder (during eating / near end of eating / peak moments)
SECTION_PLAYBACK_CLIP = "Playback Clip Builder"
LABEL_PARTICIPANT_ID = "Participant ID:"
BUTTON_BUILD_PLAYBACK_CLIP = "Build Playback Clip"
TEXT_PLAYBACK_CLIP_STATUS_IDLE = "No playback clip built yet."
TEXT_PLAYBACK_CLIP_BUILT_STATUS = "Saved {name} ({total:.0f}s: {details})."
PLAYBACK_CLIP_BUSY_TITLE = "Building Playback Clip"
TEXT_PROGRESS_FINDING_MOMENTS = "Locating moments"
TEXT_PROGRESS_WRITING_PLAYBACK_CLIP = "Writing playback clip"
MSG_PARTICIPANT_ID_REQUIRED = "Please enter a participant ID (could not parse one from the filename)."
MSG_FAILED_BUILD_PLAYBACK_CLIP = "Failed to build playback clip: {error}"
